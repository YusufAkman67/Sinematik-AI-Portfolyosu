...
tests/                 # Birim ve entegrasyon testleri (39 test)
...
Uygulamada yer alan tüm birim ve entegrasyon testlerini (toplam 39 adet) koşturmak için terminalde şu komutu çalıştırınız:
```bash
